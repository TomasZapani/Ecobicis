 ...
 * @author tm_galli
 */
public class ReportesAccidentes extends javax.swing.JFrame {

    /**
     * Creates new form ReportesAccidentes
     */
    public ReportesAccidentes() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Reportes y accidentes");

        jLabel2.setText("Descripción");

        jLabel3.setText("Fecha:");

        jLabel4.setText("Tipo de accidente:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportesAccidentes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReportesAccidentes().setVisible(true);
            }
        });
    }
